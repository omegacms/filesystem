...
{
    /**
     * @var Connection|null $connection The FTP connection resource.
     */
    protected ?Connection  $connection = null;

    /**
     * @var string $host The hostname of the FTP server.
     */
    protected string $host;

    /**
     * @var string $username The username for FTP authentication.
     */
    protected string $username;

    /**
     * @var string $password The password for FTP authentication.
     */
    protected string $password;

    /**
     * @var int $port The port number for the FTP connection (default: 21).
     */
    protected int $port;

    /**
     * @var bool $passive Indicates whether to use passive mode for the FTP connection.
     */
    protected bool $passive;

    /**
     * @var bool $create Indicates whether to create directories if they do not exist.
     */
    protected bool $create;

    /**
     * @var int $mode The mode for file transfers (default: FTP_BINARY).
     */
    protected int $mode;

    /**
     * @var bool $ssl Indicates whether to use SSL for the FTP connection.
     */
    protected bool $ssl;

    /**
     * @var int $timeout The timeout in seconds for the FTP connection (default: 90).
     */
    protected int $timeout;

    /**
     * @var bool $utf8 Indicates whether to enable UTF-8 encoding for file names.
     */
    protected bool $utf8;

    /**
     * @var string $directory The default directory on the FTP server.
     */
    protected string $directory;

    /**
     * @var array $fileData Stores the file metadata.
     */
