 ...
 * @version     1.0.0
 */
class Local implements FilesystemAdapterInterface, StreamFactoryInterface, ChecksumCalculatorInterface, SizeCalculatorInterface, MimeTypeProviderInterface
{
    /**
