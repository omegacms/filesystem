    ...
    MimeTypeProviderInterface
{
   ...
   protected function guessContentType(string $content): string
     ...
     * {@inheritdoc}
     */
    public abstract function read(string $key): string|bool;

    /**
     * {@inheritdoc}
     */
    public abstract function write(string $key, string $content): int|bool;
     ...
     * {@inheritdoc}
     */
    public abstract function mtime(string $key): int|bool;

    /**
     * {@inheritdoc}
     */
    public abstract function size(string $key): int|false;

    /**
     * {@inheritdoc}
     */
    public abstract function listKeys(string $prefix = ''): array;

    /**
     * {@inheritdoc}
     */
    public abstract function isDirectory(string $key): bool;
     ...
     */
    protected abstract function ensureBucketExists(): bool;

    /**
     * {@inheritdoc}
     */
    public abstract function mimeType(string  $key): string|false;
     ...
     */
    protected abstract function createClient(array $config): object;
}