...
class StreamWrapper
{
    /** @var FilesystemMap $filesystemMap The map of filesystems used by the stream wrapper. */
    private static FilesystemMap $filesystemMap;

    /** @var StreamInterface $stream The current stream being manipulated by this wrapper. */
