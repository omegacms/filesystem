...
class InMemoryBuffer implements StreamInterface
{
     ...
     *
     * @var StreamMode $mode Holds the mode of the stream (read/write).
     */
     ...
     *
     * @var string $content Holds the content of the stream as a string.
     */
     ...
     *
     * @var int $numBytes Holds total number of bytes in the buffer.
     */
     ...
     *
     * @var int $position Holds the current read/write position in the buffer.
     */
     ...
     *
     * @var bool $synchronized Indicates if the buffer content is synchronized with the filesystem.
     */
