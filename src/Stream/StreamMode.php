...
class StreamMode
{
    /** @var string $base The base mode character (r, w, a, etc.) */
    private string $base;

    /** @var bool $plus Indicates if the mode includes a '+' character for reading and writing */
    private bool $plus;

    /** @var string $flag Additional flags from the mode string (e.g., b for binary) */
    private string $flag;
